...
const classes = {
  root: "inline-flex items-center justify-center flex-shrink-0 font-semibold leading-none rounded outline-none transition duration-300 ease-in-out focus:outline-none focus:shadow focus:ring-1 focus:ring-primary-700",
  normal:
    "bg-primary text-white border border-transparent hover:bg-primary/90 ",
  custom: "border border-transparent",
  outline:
    "border border-border-400 bg-transparent text-body hover:text-white hover:bg-primary hover:border-accent",
  loading:
